...
<table>
	<tr>
	<td>User ID</td>
    <td>'.$_SESSION["exp_id"].'</td>
    <td></td>
</tr>
<tr>
	<td>Name</td>
    <td>'.$_SESSION['exp_name'].'</td>
    <td>
    <form action="exp_update_pro.php" method="post">
<input type="submit" class="button1 button5" name="ch_name"  value="CHANGE">
    </form></td>
</tr>
<tr>
	<td>Email</td>
    <td>'.$_SESSION['exp_email'].'</td>
    <td>
    <form action="exp_update_pro.php" method="post">
...
<tr>
	<td>Language</td>
    <td>'.$_SESSION["exp_lang"].'</td>
    <td>
    <form action="exp_update_pro.php" method="post">
<input type="submit" class="button1 button5" name="ch_lang"  value="CHANGE">
    </form></td>
</tr>
<tr>
	<td>Expertise</td>
    <td>'.$_SESSION["exp_expertise"].'</td>
    <td>
    <form action="exp_update_pro.php" method="post">
<input type="submit" class="button1 button5" name="ch_exp"  value="CHANGE">
    </form></td>
</tr>
</table>';
?>
