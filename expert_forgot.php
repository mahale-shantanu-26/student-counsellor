...
<html>
<head>
<title>Forgot Password - Expert</title>
...
include_once 'dbh.php';
    ...
    if($remail=='')
    {
        echo 'Khali hai be';
			...
			{
                $sql="SELECT * FROM expert WHERE email='$remail'";
                $result=$conn->query($sql);
                if(!$row=mysqli_fetch_assoc($result)){
                echo 'does_not_exists';
                }
                else{
                        $missionary=mysqli_query($conn,"SELECT pswd FROM expert WHERE email='$remail'");
                        ...
                        if(!$mail->send()) {
                            ...
                            <br><br>
                            <center><a href="experts.php" class="button1 button5">BACK</a></center>';
                        }
			        }
                }
