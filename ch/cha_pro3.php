...
$lang=$_POST['c3'];
if($lang){
    $sql = "UPDATE expert SET lang='$lang' WHERE cid ='$id' ";
    mysqli_query($conn,$sql);
    $_SESSION['exp_lang']=$lang;
    echo "<h4 style='font-family:cambria;'>Your language has been changed! </h4>";
}
else {
    echo "<h4 style='font-family:cambria;'>Your language could not be changed! </h4>";
}
?>
