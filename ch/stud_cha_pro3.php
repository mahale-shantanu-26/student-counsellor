...
$dob=$_POST['c3'];
if($dob){
    $sql = "UPDATE student SET dob='$dob' WHERE sid ='$id' ";
    mysqli_query($conn,$sql);
    $_SESSION['user_dob']=$dob;
    echo "<h4 style='font-family:cambria;'>Your date of birth has been changed! </h4>";
}
else {
    echo "<h4 style='font-family:cambria;'>Your date of birth could not be changed! </h4>";
}
?>
